    ...
    >
      ...
      >
        <g clipPath="url(#clip0_1_31)" id="Scribble">
          <path d={svgPaths.scribble} fill="#C51A60" id="Vector" />
        </g>
        <defs>
...
export function PricingHeader({
  plusJakartaSansClass,
  instrumentSerifClass,
}: PricingHeaderProps) {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative w-full">
      <div
        className={`flex flex-col ${plusJakartaSansClass} font-normal justify-center leading-[0] relative shrink-0 text-[32px] text-slate-950 w-full max-w-[504px]`}
      >
      ...
      <div
        className={`flex flex-col ${instrumentSerifClass} justify-center leading-[0] not-italic relative shrink-0 text-[32px] text-slate-950`}
      >
